...
public class EmployeeChangePassword extends javax.swing.JFrame {
    ...
    Register re;
    public EmployeeChangePassword(Register re) {
        initComponents();
        this.re=re;
        jLabel5.setText("Welcome : "+re.getName());
        setResizable(false);
    }
    ...
    private void initComponents() {
        ...
        setTitle("EmployeeChangePassword");
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
         ...
         boolean status=  DbOperations.checkOldPassword(old_pwd, re.getEmail());
         if(status)
         {
            if(new_pwd.equals(cnew_pwd))
            {
                if(DbOperations.updatePassword(new_pwd, re.getEmail()))
                {
                ...
                {
                    JOptionPane.showMessageDialog(rootPane, "Password didnt updated due to some error","Password Failed",JOptionPane.ERROR_MESSAGE);
                }
            }
            else
            {
                 JOptionPane.showMessageDialog(rootPane, "New Password And Confirm new password didnt matched","Password Error",JOptionPane.ERROR_MESSAGE);
            }    
         }
         else
         {
             JOptionPane.showMessageDialog(rootPane,"Old Password didnt matched","Password Error",JOptionPane.ERROR_MESSAGE);
         }          
